    ...
    if (byteChunkArray.length > 0) {
        ...
        reader.onloadend = function(evt) {
            if (evt.target.readyState == FileReader.DONE) { //Make sure read was successful, DONE == 2
                ...
                Visualforce.remoting.Manager.invokeAction('{!$RemoteAction.FileUploadController.attachBlob}', parentId, attachmentId, currentFile.name, currentFile.type, 'This is text', function(result, event) {
