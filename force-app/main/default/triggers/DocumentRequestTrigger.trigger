trigger DocumentRequestTrigger on Document_Request__c (before insert, after insert) {
    if(trigger.isInsert && trigger.isBefore){
        for(Document_Request__c dr: Trigger.New){
    ...
    if (trigger.isAfter && trigger.isInsert){
        ...
        MailUtilities.sendHTMLEmail(recipients, emailSubject, htmlBody, null);
    }
