trigger DHSDocumentRequestTrigger on DHS_Document_Request__c (before insert, after insert) { // NOPMD - Legacy trigger behavior retained for compatibility.
    ...
    if (trigger.isAfter && trigger.isInsert){
        ...
        for (DHS_Document_Request__c dr: Trigger.new){
            ...
            recipients.add(dr.Additional_To_Address__c); // NOPMD - Legacy trigger behavior retained for compatibility.
