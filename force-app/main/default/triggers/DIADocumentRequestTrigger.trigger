trigger DIADocumentRequestTrigger on DIA_Document_Request__c (before insert, after insert) {
    if(trigger.isInsert && trigger.isBefore){
        for(DIA_Document_Request__c dr: Trigger.New){
    ...
    if (trigger.isAfter && trigger.isInsert){
        ...
        for (DIA_Document_Request__c dr: Trigger.new){
            ...
            recipients.add(dr.Additional_To_Address__c);
        ...
        String decodedId = decodeURLParams(encodedId);
        String encodedUrl = 'https://insight-isn-usda-sites.cs32.force.com/SPortal/apex/SubjectDocumentsUpload?id='+encodedId;
        String decodedUrl = 'https://insight-isn-usda-sites.cs32.force.com/SPortal/apex/SubjectDocumentsUpload?id='+decodedId;

        String emailSubject = 'Testing';
        String htmlBody = 'Hello, <br/><br/>'+notes+'<br/><br/><a href="'+encodedUrl+'" target="_blank">Upload Docs</a><br/><br/>';
        
        MailUtilities.sendBIEmail(emailSubject,htmlBody,recipients,null,null);
    }
    ...
    private String encodeURLParams(String inputString){
        ...
        System.debug(inputString + ' is now encoded as: ' + paramvalue);
